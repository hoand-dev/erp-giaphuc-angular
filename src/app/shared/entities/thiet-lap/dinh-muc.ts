export class DinhMuc {
    ...
    constructor(
        ...
        ghichu: string = null,
        madinhmuc: string = null,
        tendinhmuc: string = null,
        danhmucgiacong_id: number = null,
        dinhmuc_nguyenlieu: DinhMuc_NguyenLieu[] = null,
        dinhmuc_nguonluc: DinhMuc_NguonLuc[] = null,
        dinhmuc_chiphikhac: DinhMuc_ChiPhiKhac[] = null
    ) {
        this.id = id;
