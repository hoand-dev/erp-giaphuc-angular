...
export class NoiDungThuChiCapNhatComponent implements OnInit, OnDestroy {
    ...
    constructor(private router: Router, private activatedRoute: ActivatedRoute, private authenticationService: AuthenticationService, private noidungthuchiService: NoiDungThuChiService) {}
    ...
    ngOnInit(): void {
        ...
        this.subscriptions.add(
            this.activatedRoute.params.subscribe((params) => {
                ...
                if (noidungthuchi_id) {
                    this.subscriptions.add(
                        this.noidungthuchiService.findNoiDungThuChi(noidungthuchi_id).subscribe(
                            (data) => {
    ...
    onSubmitForm(e) {
        ...
        this.subscriptions.add(
            this.noidungthuchiService.updateNoiDungThuChi(noidungthuchi_req).subscribe(
                (data) => {
                    notify(
                        {
                            width: 320,
