...
export class TaiXeThemMoiComponent implements OnInit {
    ...
    constructor(private router: Router, private authenticationService: AuthenticationService, private taixeService: TaiXeService) {}
    ...
    onSubmitForm(e) {
        ...
        this.subscriptions.add(
            this.taixeService.addTaiXe(taixe_req).subscribe(
                (data) => {
                    notify(
                        {
                            width: 320,
