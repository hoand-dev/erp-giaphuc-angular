...
export class DonViTinhThemMoiComponent implements OnInit {
    ...
    constructor(private router: Router, private authenticationService: AuthenticationService, private donvitinhService: DonViTinhService) {}
    ...
    onSubmitForm(e) {
        ...
        this.subscriptions.add(
            this.donvitinhService.addDonViTinh(donvitinh_req).subscribe(
                (data) => {
                    notify(
                        {
                            width: 320,
