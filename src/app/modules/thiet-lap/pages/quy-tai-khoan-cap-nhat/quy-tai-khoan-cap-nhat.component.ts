...
export class QuyTaiKhoanCapNhatComponent implements OnInit, OnDestroy {
    ...
    constructor(private router: Router, private activatedRoute: ActivatedRoute, private authenticationService: AuthenticationService, private quytaikhoanService: QuyTaiKhoanService) {}
    ...
    ngOnInit(): void {
        ...
        this.subscriptions.add(
            this.activatedRoute.params.subscribe((params) => {
                ...
                if (quytaikhoan_id) {
                    this.subscriptions.add(
                        this.quytaikhoanService.findQuyTaiKhoan(quytaikhoan_id).subscribe(
                            (data) => {
    ...
    onSubmitForm(e) {
        ...
        this.subscriptions.add(
            this.quytaikhoanService.updateQuyTaiKhoan(quytaikhoan_req).subscribe(
                (data) => {
                    notify(
                        {
                            width: 320,
