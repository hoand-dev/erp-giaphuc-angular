...
export class NhomKhachHangCapNhatComponent implements OnInit {
    ...
    constructor(private router: Router, private activatedRouter: ActivatedRoute, private authenticationService: AuthenticationService, private nhomkhachhangService: NhomKhachHangService) {}
    ...
    ngOnInit(): void {
        ...
        this.subscriptions.add(
            this.activatedRouter.params.subscribe((params) => {
                ...
                if (nhomkhachhang_id) {
                    this.subscriptions.add(
                        this.nhomkhachhangService.findNhomKhachHang(nhomkhachhang_id).subscribe(
                            (data) => {
    ...
    onSubmitForm(e) {
        ...
        this.subscriptions.add(
            this.nhomkhachhangService.updateNhomKhachHang(nhomkhachhang_req).subscribe(
                (data) => {
                    notify(
                        {
                            width: 320,
