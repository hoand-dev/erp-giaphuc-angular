...
export class DanhMucGiaCongCapNhatComponent implements OnInit, OnDestroy {
    ...
    constructor(private router: Router, private activatedRoute: ActivatedRoute, private authenticationService: AuthenticationService, private danhmucgiacongService: DanhMucGiaCongService) {}
        ...
        this.subscriptions.add(
            this.activatedRoute.params.subscribe((params) => {
                ...
                if (danhmucgiacong_id) {
                    this.subscriptions.add(
                        this.danhmucgiacongService.findDanhMucGiaCong(danhmucgiacong_id).subscribe(
                            (data) => {
    ...
    onSubmitForm(e) {
        ...
        this.subscriptions.add(
            this.danhmucgiacongService.updateDanhMucGiaCong(danhmucgiacong_req).subscribe(
                (data) => {
                    notify(
                        {
                            width: 320,
