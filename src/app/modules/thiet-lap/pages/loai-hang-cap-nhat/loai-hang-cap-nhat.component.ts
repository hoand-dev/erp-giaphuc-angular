...
export class LoaiHangCapNhatComponent implements OnInit {
    ...
    constructor(private router: Router, private activatedRoute: ActivatedRoute, private authenticationService: AuthenticationService, private loaihangService: LoaiHangService) {}
    ...
    ngOnInit(): void {
        ...
        this.subscriptions.add(
            this.activatedRoute.params.subscribe((params) => {
                ...
                if (loaihang_id) {
                    this.subscriptions.add(
                        this.loaihangService.findLoaiHang(loaihang_id).subscribe(
                            (data) => {
    ...
    onSubmitForm(e) {
        ...
        this.subscriptions.add(
            this.loaihangService.updateLoaiHang(loaihang_req).subscribe(
                (data) => {
                    notify(
                        {
                            width: 320,
