...
export class DanhMucLoiThemMoiComponent implements OnInit {
    ...
    constructor(private router: Router, private danhmucloiService: DanhMucLoiService, private authenticationService: AuthenticationService) {}
    ...
    onSubmitForm(e) {
        ...
        this.subscriptions.add(
            this.danhmucloiService.addDanhMucLoi(danhmucloi_req).subscribe(
                (data) => {
                    notify(
                        {
                            width: 320,
