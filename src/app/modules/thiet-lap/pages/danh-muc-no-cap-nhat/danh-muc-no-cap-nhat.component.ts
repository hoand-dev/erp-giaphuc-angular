...
export class DanhMucNoCapNhatComponent implements OnInit, OnDestroy {
    ...
    constructor(private router: Router, private activatedRoute: ActivatedRoute, private authenticationService: AuthenticationService, private danhmucnoService: DanhMucNoService) {}
    ...
    ngOnInit(): void {
        ...
        this.subscriptions.add(
            this.activatedRoute.params.subscribe((params) => {
                ...
                if (danhmucno_id) {
                    this.subscriptions.add(
                        this.danhmucnoService.findDanhMucNo(danhmucno_id).subscribe(
                            (data) => {
    ...
    onSubmitForm(e) {
        ...
        this.subscriptions.add(
            this.danhmucnoService.updateDanhMucNo(danhmucno_req).subscribe(
                (data) => {
                    notify(
                        {
                            width: 320,
