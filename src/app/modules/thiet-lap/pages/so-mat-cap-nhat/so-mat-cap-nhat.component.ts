...
export class SoMatCapNhatComponent implements OnInit, OnDestroy {
    ...
    constructor(private router: Router, private activatedRoute: ActivatedRoute, private authenticationService: AuthenticationService, private somatService: SoMatService) {}
    ...
    ngOnInit(): void {
        ...
        this.subscriptions.add(
            this.activatedRoute.params.subscribe((params) => {
                ...
                if (somat_id) {
                    this.subscriptions.add(
                        this.somatService.findSoMat(somat_id).subscribe(
                            (data) => {
                                this.somat = data[0];
    ...
    onSubmitForm(e) {
        ...
        this.subscriptions.add(
            this.somatService.updateSoMat(somat_req).subscribe(
                (data) => {
                    notify(
                        {
                            width: 320,
