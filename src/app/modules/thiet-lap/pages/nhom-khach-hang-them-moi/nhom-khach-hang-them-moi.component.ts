...
export class NhomKhachHangThemMoiComponent implements OnInit {
    ...
    constructor(private router: Router, private activatedRoute: ActivatedRoute, private nhomkhachhangService: NhomKhachHangService, private authenticationService: AuthenticationService) {}
    ...
    onSubmitForm(e) {
        ...
        this.subscriptions.add(
            this.nhomkhachhangService.addNhomKhachHang(nhomkhachhang_req).subscribe(
                (data) => {
                    notify(
                        {
                            width: 320,
