...
export class DanhSachXeCapNhatComponent implements OnInit {
    ...
    constructor(private router: Router, private activatedRoute: ActivatedRoute, private authenticationService: AuthenticationService, private danhsachxeService: DanhSachXeService) {}
    ...
    ngOnInit(): void {
        ...
        this.subscriptions.add(
            this.activatedRoute.params.subscribe((params) => {
                ...
                if (danhsachxe_id) {
                    this.subscriptions.add(
                        this.danhsachxeService.findDanhSachXe(danhsachxe_id).subscribe(
                            (data) => {
    ...
    onSubmitForm(e) {
        ...
        this.subscriptions.add(
            this.danhsachxeService.updateDanhSachXe(danhsachxe_req).subscribe(
                (data) => {
                    notify(
                        {
                            width: 320,
