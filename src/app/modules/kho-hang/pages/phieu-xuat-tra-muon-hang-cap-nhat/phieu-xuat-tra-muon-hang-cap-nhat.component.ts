...
@Component({
    selector: 'app-phieu-xuat-tra-muon-hang-cap-nhat',
    templateUrl: './phieu-xuat-tra-muon-hang-cap-nhat.component.html',
    styleUrls: ['./phieu-xuat-tra-muon-hang-cap-nhat.component.css']
})
export class PhieuXuatTraMuonHangCapNhatComponent implements OnInit {
    ...
    ngOnInit(): void {
        ...
        this.subscriptions.add(
            this.activatedRoute.params.subscribe((params) => {
                let phieuxuattramuonhang_id = params.id;
                // lấy thông tin
                if (phieuxuattramuonhang_id) {
                    this.subscriptions.add(
                        this.phieuxuattramuonhangService.findPhieuXuatTraMuonHang(phieuxuattramuonhang_id).subscribe(
                            (data) => {
    ...
    openModal() {
        ...
        /* hiển thị modal */
        this.bsModalRef = this.modalService.show(DanhSachPhieuNhapMuonHangModalComponent, { class: 'modal-xxl modal-dialog-centered', ignoreBackdropClick: true, keyboard: false, initialState });
    ...
    public onSubmitForm(e) {
        ...
        this.subscriptions.add(
            this.phieuxuattramuonhangService.updatePhieuXuatTraMuonHang(phieuxuattramuonhang_req).subscribe(
                (data) => {
                    notify(
                        {
                            width: 320,
