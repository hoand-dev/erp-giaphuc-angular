...
export class PhieuNhapTraMuonHangThemMoiComponent implements OnInit {
    ...
    openModal() {
        ...
        /* hiển thị modal */
        this.bsModalRef = this.modalService.show(DanhSachPhieuXuatMuonHangModalComponent, { class: 'modal-xxl modal-dialog-centered', ignoreBackdropClick: true, keyboard: false, initialState });
