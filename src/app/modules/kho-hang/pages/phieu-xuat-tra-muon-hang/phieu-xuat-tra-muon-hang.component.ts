...
export class PhieuXuatTraMuonHangComponent implements OnInit, OnDestroy, AfterViewInit {
    ...
    constructor(private router: Router, private objPhieuXuatTraMuonHangService: PhieuXuatTraMuonHangService, private authenticationService: AuthenticationService) {}
