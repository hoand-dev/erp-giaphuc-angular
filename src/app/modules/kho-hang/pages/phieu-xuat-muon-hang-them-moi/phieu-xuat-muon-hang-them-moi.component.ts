...
@Component({
    selector: 'app-phieu-xuat-muon-hang-them-moi',
    templateUrl: './phieu-xuat-muon-hang-them-moi.component.html',
    styleUrls: ['./phieu-xuat-muon-hang-them-moi.component.css']
})
export class PhieuXuatMuonHangThemMoiComponent implements OnInit {
    ...
    public onSubmitForm(e) {
        ...
        this.subscriptions.add(
            this.phieuxuatmuonhangService.addPhieuXuatMuonHang(phieuxuatmuonhang_req).subscribe(
                (data) => {
                    notify(
                        {
                            width: 320,
