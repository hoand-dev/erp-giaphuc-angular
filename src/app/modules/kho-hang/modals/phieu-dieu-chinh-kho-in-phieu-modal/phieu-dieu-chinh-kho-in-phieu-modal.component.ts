...
export class PhieuDieuChinhKhoInPhieuModalComponent implements OnInit {
  ...
  constructor(public bsModalRef: BsModalRef, private nguoidungService: NguoiDungService, private objPhieuDieuChinhKhoService: PhieuDieuChinhKhoService, private authenticationService: AuthenticationService) { }
    ...
    this.subscriptions.add(
        this.objPhieuDieuChinhKhoService.findPhieuDieuChinhKho(this.phieudieuchinhkho_id).subscribe(
            (data) => {
               ...
               data.ngaylapphieu = moment(data.ngaydieuchinhkho).format('HH:mm DD/MM/YYYY');
