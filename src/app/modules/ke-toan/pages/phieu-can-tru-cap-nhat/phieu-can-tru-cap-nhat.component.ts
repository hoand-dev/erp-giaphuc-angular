...
@Component({
    ...
    templateUrl: './phieu-can-tru-cap-nhat.component.html',
    styleUrls: ['./phieu-can-tru-cap-nhat.component.css']
})
export class PhieuCanTruCapNhatComponent implements OnInit {
    ...
    ngOnInit(): void {
        ...
        this.subscriptions.add(
            this.activatedRoute.params.subscribe((params) => {
                let phieucantru_id = params.id;
                // lấy thông tin
                if (phieucantru_id) {
                    this.subscriptions.add(
                        this.phieucantruService.findPhieuCanTru(phieucantru_id).subscribe(
                            (data) => {
    ...
    public onSubmitForm(e) {
        ...
        this.subscriptions.add(
            this.phieucantruService.updatePhieuCanTru(phieucantru_req).subscribe(
                (data) => {
                    notify(
                        {
                            width: 320,
