...
export class PhieuKhachTraHangThemMoiComponent implements OnInit {
    ...
    private onTinhTien() {
        ...
        this.hanghoas.forEach((v, i) => {
            ...
            let chietkhau = this.phieukhachtrahang.chietkhau != 0 ? this.phieukhachtrahang.chietkhau : v.chietkhau;
            let thuevat   = this.phieukhachtrahang.thuevat   != 0 ? this.phieukhachtrahang.thuevat   : v.thuevat  ;
        ...
        this.phieukhachtrahang.tongthanhtien = tongthanhtien;
    }
