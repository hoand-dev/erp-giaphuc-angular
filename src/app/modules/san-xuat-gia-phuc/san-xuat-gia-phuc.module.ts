...
@NgModule({
  declarations: [LenhSanXuatComponent, LenhSanXuatModalComponent, PhieuXuatVatTuModalComponent, PhieuXuatVatTuComponent, PhieuNhapVatTuModalComponent, DanhSachLenhSanXuatModalComponent, DanhSachPhieuXuatVatTuModalComponent, PhieuNhapVatTuComponent],
  imports: [
    CommonModule,
    SharedModule,
