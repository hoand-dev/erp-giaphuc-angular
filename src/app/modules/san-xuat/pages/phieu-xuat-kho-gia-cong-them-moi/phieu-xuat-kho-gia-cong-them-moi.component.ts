...
@Component({
    selector: 'app-phieu-xuat-kho-gia-cong-them-moi',
    templateUrl: './phieu-xuat-kho-gia-cong-them-moi.component.html',
    styleUrls: ['./phieu-xuat-kho-gia-cong-them-moi.component.css']
})
export class PhieuXuatKhoGiaCongThemMoiComponent implements OnInit {
    ...
    public onSubmitForm(e) {
        ...
        this.subscriptions.add(
            this.phieuxuatkhogiacongService.addPhieuXuatKhoGiaCong(phieuxuatkhogiacong_req).subscribe(
                (data) => {
                    notify(
                        {
                            width: 320,
