...
@Component({
    selector: 'app-bang-gia-gia-cong-cap-nhat',
    templateUrl: './bang-gia-gia-cong-cap-nhat.component.html',
    styleUrls: ['./bang-gia-gia-cong-cap-nhat.component.css']
})
export class BangGiaGiaCongCapNhatComponent implements OnInit {
    ...
    ngOnInit(): void {
        ...
        this.subscriptions.add(
            this.activatedRoute.params.subscribe((params) => {
                let banggiagiacong_id = params.id;
                // lấy thông tin
                if (banggiagiacong_id) {
                    this.subscriptions.add(
                        this.banggiagiacongService.findBangGiaGiaCong(banggiagiacong_id).subscribe(
                            (data) => {
                                this.banggiagiacong = data;
                                this.chitiets = this.banggiagiacong.banggiagiacong_chitiets;
                                this.banggiagiacong.banggiagiacong_chitiets_old = this.banggiagiacong.banggiagiacong_chitiets;
                            },
                            (error) => {
    ...
    public onSubmitForm(e) {
        ...
        this.subscriptions.add(
            this.banggiagiacongService.updateBangGiaGiaCong(banggiagiacong_req).subscribe(
                (data) => {
                    notify(
                        {
                            width: 320,
